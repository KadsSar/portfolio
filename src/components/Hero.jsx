        ...
        <div className="relative h-[85vh] w-full text-white">
            ...
            <div className="relative z-10 flex flex-col justify-center h-full px-4 md:px-8 w-full md:w-2/3 lg:w-1/2 space-y-6 pt-20">
                ...
                <div className="flex items-center space-x-4 text-gray-300 text-sm md:text-lg font-medium drop-shadow-md">
                    ...
                    <a href={`${import.meta.env.BASE_URL}assets/Sarisha_Kadakia_Resume.pdf`} target="_blank" rel="noopener noreferrer" className="cursor-pointer hover:text-white transition duration-300">Resume</a>
