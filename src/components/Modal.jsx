...
const Modal = ({ item, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-fade-in">
            <div className={`relative w-full ${item.details ? 'max-w-3xl' : 'max-w-4xl'} bg-[#181818] rounded-md shadow-2xl overflow-hidden animate-scale-up max-h-[85vh] overflow-y-auto custom-scrollbar`}>
                {/* Close Button */}
                <button
